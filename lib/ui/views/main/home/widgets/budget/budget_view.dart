  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<BudgetViewModel>.reactive(
      ...
      builder: (
        ...
        return StatusBar(
          child: model.showCreateBudget ? CreateBudgetView(model: model,) : Scaffold(
            floatingActionButton: FloatingActionButton(onPressed: model.setShowCreateBudget, backgroundColor: kcPrimaryColor, child: const Icon(Icons.add, size: 35,),),
              appBar: AppBar(
                title: Text(
                  budgetText,
              ...
              Container(
                ...
                child: ListView.separated(
                  shrinkWrap: true,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text('${model.budgetsToDisplay[index].category}',
                                      style: heading6Style.copyWith(
                              ...
                              const Spacer(),
                              Text('${model.budgetsToDisplay[index].date}',
                                  style: heading6Style.copyWith(
                                    fontWeight: FontWeight.w400,
                                    color: kcNeutral4,
                                    fontSize: 14,
                    ...
                    separatorBuilder: (context, index) => verticalSpaceVeryTiny,
